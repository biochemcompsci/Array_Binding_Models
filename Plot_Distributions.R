...
#   GT2_8 <- GT2_8/max(GT2_8[,1])
  ...
  GT2_0_Specific <- as.data.frame(as.numeric(currData1[,as.character(currCol)])[intersect(which(specificityRatioCurrData1[,as.character(currCol)] >= 2, arr.ind = TRUE),which(currData1[,as.character(currCol)] >= 0, arr.ind = TRUE))])
  GT2_1_Specific <- as.data.frame(as.numeric(currData1[,as.character(currCol)])[intersect(which(specificityRatioCurrData1[,as.character(currCol)] >= 2, arr.ind = TRUE),which(currData1[,as.character(currCol)] >= 1, arr.ind = TRUE))])
  GT2_2_Specific <- as.data.frame(as.numeric(currData1[,as.character(currCol)])[intersect(which(specificityRatioCurrData1[,as.character(currCol)] >= 2, arr.ind = TRUE),which(currData1[,as.character(currCol)] >= 2, arr.ind = TRUE))])
  GT2_4_Specific <- as.data.frame(as.numeric(currData1[,as.character(currCol)])[intersect(which(specificityRatioCurrData1[,as.character(currCol)] >= 2, arr.ind = TRUE),which(currData1[,as.character(currCol)] >= 4, arr.ind = TRUE))])
  GT2_8_Specific <- as.data.frame(as.numeric(currData1[,as.character(currCol)])[intersect(which(specificityRatioCurrData1[,as.character(currCol)] >= 2, arr.ind = TRUE),which(currData1[,as.character(currCol)] >= 8, arr.ind = TRUE))])
